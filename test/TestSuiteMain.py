...
TC_04_NAME = "PULL CHAIN EXPRESSION TEST 04 (MULTILINES)"
PULL_CHAIN_04 = """m'PULL_EXAMPLE_02_01: r'"ID"\s*:\s*([0-9]+)\s*'.PULL({0}==[10,15])\nPULL_EXAMPLE_02_02: r'"NAME"\s*:\s*"([A-Z0-9]+)"'.PULL({0}==["OBJ010","OBJ015"])\n\nPULL_EXAMPLE_02: PULL_EXAMPLE_02_01 + PULL_EXAMPLE_02_02'.PULL(PULL_EXAMPLE_02)"""
tcPullChain.checkUsePullChain(TC_04_NAME, PULL_CHAIN_04, JSON_EXAMPLE_02_TRUE, True)

TC_05_NAME = "PULL CHAIN EXPRESSION TEST 05 (MULTILINES)"
PULL_CHAIN_05 = """m'PULL_EXAMPLE_02_01: r'"ID"\s*:\s*([0-9]+)\s*'.PULL({0}==[10,15])\nPULL_EXAMPLE_02_02: r'"NAME"\s*:\s*"([A-Z0-9]+)"'.PULL({0}==["OBJ010","OBJ015"])\n\nPULL_EXAMPLE_02: PULL_EXAMPLE_02_01 + PULL_EXAMPLE_02_02'.PULL(PULL_EXAMPLE_02_01 + PULL_EXAMPLE_02_02)"""
tcPullChain.checkUsePullChain(TC_05_NAME, PULL_CHAIN_05, JSON_EXAMPLE_03_TRUE, True)
tcPullChain.checkUsePullChain(TC_05_NAME, PULL_CHAIN_05, JSON_EXAMPLE_03_FALSE, False)
